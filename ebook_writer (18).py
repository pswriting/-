...
- 러시아어, 일본어, 중국어 등 외국 문자 사용 금지
- 영어 단어는 꼭 필요한 경우만 (예: CEO, SNS, AI)
- "naive"를 "наив"로 쓰는 등 외국어 철자 금지
- 한글로 자연스럽게 표현하세요

[★★★ 어색한 밈/관용구 절대 금지 ★★★]

다음과 같은 억지스러운 표현 사용 금지:
- "묻고 더블로 가!" - 절대 사용 금지
- "도시락 싸 들고 말리고 싶습니다" - 절대 사용 금지
- "이건 사랑입니다" 같은 과장된 감정 표현
- 인터넷 유행어, 밈, 드라마 대사 인용
- "~각입니다", "~하면 그만입니다" 같은 유행어
- 억지로 재치있어 보이려는 표현
- TV 예능/드라마에서 따온 표현

자연스럽고 담백한 문장으로만 작성하세요.
...
[외국어/어색한 표현 수정]
- 러시아어, 일본어 등 외국 문자 → 한글로 교체
- "묻고 더블로 가!" → 삭제하거나 자연스러운 표현으로
- "도시락 싸 들고 말리고 싶습니다" → 삭제
- 인터넷 밈, 유행어, 드라마 대사 → 담백한 표현으로 교체
- 억지 재치 표현 → 자연스러운 문장으로
