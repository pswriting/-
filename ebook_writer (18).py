...
def generate_subtopic_content(subtopic_title, chapter_title, questions, answers, topic, persona):
    """PS글쓰기 스타일로 본문 생성 - 존댓말 통일, AI티 제거"""
    ...
    prompt = f"""당신은 남현우 작가(PS글쓰기)처럼 글을 쓰는 베스트셀러 작가입니다.
...
4. 첫 문장은 강렬하게
   - 독자가 "뭐지?" 하고 멈추게 만드세요
   - 결론이나 충격적 사실부터 시작하세요
   - 나쁜 예: "오늘은 투자에 대해 알아보겠습니다."
   - 좋은 예: "통장 잔고 47만원. 저는 바닥이었습니다."

5. 구체적 숫자와 상황 묘사
   - "열심히 했다" 대신 "새벽 4시에 일어났습니다"
   - "많이 벌었다" 대신 "월 300만원을 벌었습니다"
   - 언제, 어디서, 무슨 일이 있었는지 구체적으로

6. 스토리로 설득
   - 교훈 대신 경험담을 들려주세요
   - 실패 → 깨달음 → 변화의 흐름으로 전개하세요
   - 독자가 공감할 수 있는 상황을 그리세요

[절대 금지 - AI 티 나는 표현]
- "실수 1:", "실수 2:", "해결책:" 같은 구조화된 표현 금지
- "첫째,", "둘째,", "셋째," 나열 금지
- "다음과 같습니다", "정리하면" 금지
- "중요합니다", "필수입니다" 반복 금지
- "~해야 합니다", "~하세요" 연속 사용 금지
- 번호 매기기(1. 2. 3.) 금지
- 마크다운(**굵게**, *기울임*) 금지
- 영어, 러시아어, 아랍어 등 외국어 금지
- 소제목이나 챕터 제목을 본문에서 반복하지 마세요

[분량]
1500~2000자 (반드시 1500자 이상)

[중요]
- 오직 '{subtopic_title}' 소제목의 내용만 작성하세요
- 다른 챕터나 소제목 내용을 포함하지 마세요
- 인터뷰 내용을 바탕으로 자연스러운 글로 풀어쓰세요

[미션]
위 인터뷰 내용을 바탕으로 '{subtopic_title}' 본문을 작성하세요.
PS글쓰기처럼 담백하고, 스토리 중심으로, 끝까지 읽게 만드세요."""

    return ask_ai("PS글쓰기 전문 작가", prompt, temperature=0.75)
