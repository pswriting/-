...
def generate_titles_advanced(topic, persona, pain_points):
    prompt = f"""당신은 '역행자', '부의 추월차선', '돈의 속성'급 베스트셀러 제목 전문가입니다.
...
🔥 베스트셀러 제목 공식:
1. 상식 뒤집기: "왜 열심히 하면 가난해질까"
2. 충격적 숫자: "47만원에서 시작한 역전"
3. 비밀 암시: "아무도 말 안 하는 진실"
4. 소외감 자극: "왜 나만 몰랐을까"

❌ 절대 금지: "~하는 비법", "노하우", "가이드", "~하는 법"

JSON 형식으로 5개 제목 생성:
{{"titles": [{{"title": "7자 이내", "subtitle": "15자 이내", "concept": "컨셉", "why_works": "이유"}}]}}"""
...
def generate_outline(topic, persona, pain_points):
    prompt = f"""당신은 '역행자', '부의 추월차선', '돈의 속성'급 베스트셀러 작가입니다.

주제: {topic}
타겟: {persona}
고민: {pain_points}

정확히 4개 챕터, 각 3개 소제목을 설계하세요.
...
[챕터 제목] 7자 이내
✅ 좋은 예: "바닥의 맛", "그들의 비밀", "첫 100만원", "역전의 시작"
❌ 나쁜 예: "성공을 위한 마인드셋", "효과적인 전략"

[소제목] 10자 이내
✅ 좋은 예: "47만원의 바닥", "새벽 4시의 선택", "그 한 마디"
❌ 나쁜 예: "시간 관리의 중요성", "재정적 어려움 극복"
...
[구조]
챕터1: 문제 인식 (독자가 "내 얘기잖아" 하게)
챕터2: 원인 발견 ("이래서 안 됐구나" 깨달음)
챕터3: 해결책 제시 ("이렇게 하면 되겠다" 희망)
챕터4: 실행과 변화 ("나도 해봐야겠다" 동기부여)
...
10자 이내, 호기심 폭발, 설명형 금지

✅ 좋은 예: "새벽 4시의 선택", "47만원의 바닥"
❌ 나쁜 예: "~하는 법", "~의 중요성"
