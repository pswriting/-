...
def generate_outline(topic, persona, pain_points):
    prompt = f"""당신은 크몽/탈잉/클래스101에서 수천 권을 판매한 전자책 기획의 신입니다.
당신이 만든 목차는 목차만 보고도 결제하게 만드는 마법을 부립니다.

[분석 대상]
주제: {topic}
타겟: {persona}
타겟의 진짜 고민: {pain_points}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔥 프드프 킬러 목차의 7가지 심리 트리거
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

[트리거 1] 🎯 뒤통수 한 방 (인지 부조화)
"당신이 알던 건 전부 틀렸다"는 느낌
✓ "열심히 하면 망하는 이유"
✓ "성실함이 당신을 가난하게 만든다"
✓ "노력할수록 실패하는 사람들의 공통점"
✓ "저축하면 절대 부자 못 되는 이유"
...
[트리거 2] 🔢 숫자의 마법 (구체적 증거)
"진짜인 것 같다"는 신뢰감
✓ "31개월 만에 10억 만든 단 하나의 습관"
✓ "하루 47분으로 월 500 추가한 시스템"
✓ "딱 3개만 바꿨더니 수입이 4배"
✓ "21일 만에 첫 100만원이 들어온 날"

[트리거 3] 🕳️ 빈칸의 유혹 (미완성 효과)
"저게 뭐지?" 궁금해서 미칠 것 같은 느낌
✓ "상위 1%만 아는 '○○○'의 비밀"
✓ "'그것' 하나 바꿨더니 인생이 달라졌다"
✓ "부자들이 절대 입 밖에 안 꺼내는 ○○○"
✓ "99%가 모르는 '그 방법'"
...
[트리거 4] 😱 공포와 긴급함 (손실 회피)
"지금 안 하면 평생 후회한다"는 조급함
✓ "이대로면 5년 후 당신은 똑같은 자리"
✓ "아직도 이것 모르면 평생 월급쟁이"
✓ "남들은 이미 시작했습니다"
✓ "30대에 모르면 40대에 후회할 것들"

[트리거 5] 🤫 비밀 공개 (독점 정보)
"나만 아는 내부자 정보" 느낌
✓ "업계에서 절대 안 알려주는 진짜 방법"
✓ "상위 0.1%만 공유하는 시스템"
✓ "10년차 선배도 모르는 숨겨진 루트"
✓ "아무도 말 안 해주는 불편한 진실"

[트리거 6] 📖 스토리 암시 (서사적 호기심)
"무슨 일이 있었던 거야?" 궁금증
✓ "통장 잔고 47만원, 그날 밤의 결심"
✓ "퇴사 3개월 후, 월급보다 더 벌기 시작했다"
✓ "아내가 먼저 알아챈 변화"
✓ "그날 새벽 3시, 모든 게 바뀌었다"
...
🎭 4챕터 감정 곡선 설계
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
챕터1: 💥 충격 → "뭐? 내가 잘못 알고 있었어?"
챕터2: 😤 분노+깨달음 → "그래서 안 됐던 거구나!"
챕터3: 🔥 희망+비밀 → "이게 진짜 방법이었어!"
챕터4: 💪 확신+행동 → "나도 할 수 있겠다!"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📝 미션: 정확히 4개 챕터, 각 3개 소제목
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

각 챕터 제목: 20자 이내, 위 7가지 트리거 중 2개 이상 조합
각 소제목: 15자 이내, 각각 다른 트리거 사용
...
def generate_subtopics(chapter_title, topic, persona, num_subtopics=3):
    prompt = f"""당신은 목차만 보고도 결제하게 만드는 전자책 기획자입니다.
...
📝 미션
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
'{chapter_title}' 챕터의 소제목 {num_subtopics}개를 만들어주세요.
각 소제목은 서로 다른 공식을 사용하세요!
...
def regenerate_chapter_outline(chapter_number, topic, persona, existing_chapters):
    chapter_emotions = {
        1: "💥 충격 + 공감: '맞아, 이게 내 얘기야' 느낌 → 뒤통수+숫자 조합",
        2: "😤 분노 + 깨달음: '그래서 안 됐구나!' 느낌 → 반전+비밀 조합",
        3: "🔥 희망 + 비밀: '이게 답이었어!' 느낌 → 빈칸+스토리 조합",
        4: "💪 확신 + 행동: '나도 할 수 있어!' 느낌 → 숫자+미래 조합"
    }
...
🔥 킬러 목차 7가지 트리거
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. 뒤통수 한 방: "당신이 알던 건 틀렸다"
2. 숫자의 마법: "31개월 만에", "하루 47분"
3. 빈칸의 유혹: "○○○ 하나로", "'그것' 모르면"
4. 공포와 긴급함: "지금 안 하면", "남들은 이미"
5. 비밀 공개: "아무도 안 알려주는", "상위 1%만"
6. 스토리 암시: "그날 새벽 3시", "퇴사 3개월 후"
7. 반전과 역설: "적게 일해야 더 번다"

챕터 제목: 20자 이내, 트리거 2개 이상 조합
소제목: 15자 이내, 각각 다른 트리거 사용
